		...
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#" style="color:white;">Medicine Store</a>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<ul class="nav navbar-nav navbar-right">
						<li><a href="view_cart.php"><span class="badge" ><?php echo count($_SESSION['cart']); ?></span>&nbsp;<font style="color:white;">Cart</font>&nbsp;<span class="glyphicon glyphicon-shopping-cart" style="color:white;"></span></a></li>
					</ul>
				</div>
			</div>
		</nav>
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="row product_image">
							<!-- <img src="<?php echo $row['photo'] ?>" width="80%" height="auto"><br> -->
							<?php echo "<img src='../../assets/$row[photo]' width='70' height='90' />";?>
						</div>
